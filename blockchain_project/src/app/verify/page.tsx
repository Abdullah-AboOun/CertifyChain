  ...
  const handleVerify = async () => {
    ...
    if (!bytes32Regex.test(certificateId.trim())) {
      setResult({
        found: false,
        error:
          "Invalid certificate ID format. Please enter a valid bytes32 ID (0x followed by 64 hexadecimal characters)",
      });
      return;
    }
    ...
    try {
      ...
      const dbResponse = await fetch(
        `/api/trpc/certificate.getByBlockchainId?input=${encodeURIComponent(JSON.stringify(input))}`,
      );
      ...
      if (error?.code === "CALL_EXCEPTION") {
        ...
        if (
          ...
          errorMessage =
            "Certificate not found. This certificate ID does not exist on the blockchain.";
        } else {
          errorMessage =
            "Certificate not found on the blockchain. The certificate may not exist or the ID is invalid.";
        }
        ...
        errorMessage =
          "Network error. Please check your blockchain connection and try again.";
        ...
        <Card>
          <CardContent className="pt-6">
            ...
            <p className="text-muted-foreground mt-2 text-xs">
              Enter a 66-character certificate ID starting with "0x" (e.g.,
              0x1234...abcd)
            </p>
          </CardContent>
        </Card>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-lg">
                        {result.blockchainData.issuerName}
                      </p>
                ...
                <div className="space-y-4">
                  ...
                  <div className="border-muted bg-muted/50 rounded-lg border p-4">
                    ...
                    <ul className="text-muted-foreground list-inside list-disc space-y-1 text-sm">
                      <li>
                        Verify the certificate ID is exactly 66 characters (0x +
                        64 hex digits)
                      </li>
                      <li>
                        Check if you&apos;re connected to the correct blockchain
                        network
                      </li>
